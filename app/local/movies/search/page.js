        ...
        <div>
            <header className="flex justify-between p-10">
                ...
                <div className="flex justify-end">
                    ...
                    <button onClick={()=>router.push('/local/movies/create')} className="btn btn-ghost text-xs w-24 md:text-base md:w-36">Create New Movie</button>
                <label className="input input-bordered flex items-center gap-2 w-24">
                    <input ref={inputRef} type="text" className="grow w-8 h-8 text-sm" placeholder="Page" value={search} onChange={(e) => setSearch(e.target.value)} onKeyDown={handleKeyDown}/>
